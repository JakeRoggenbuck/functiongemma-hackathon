...
I was able to improve the score by almost **10%** in the given tests. This improvement didn't help the hidden tests, so it doesn't generalize well. My new router is that much better for local augmented reality applications.
